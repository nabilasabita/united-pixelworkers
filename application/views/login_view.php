      ...
      <!-- <nav id="nav-id" class="navbar navbar-default navbar-fixed-top mainNavbar">
       ...
       --><div class="mainContainer">
          ...
          <h2> Sign In </h2>
              ...
              <div style="text-align: center;"><span style="font-weight: bold;">Don't have an account?<a href="<?php echo site_url(); ?>/login_controller/register" style="color: red;">Create one here</a></span></div>
